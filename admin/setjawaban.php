  ...
  <div id=wrapper>
  	...
  	<div id=tengah>
		...
		<p align=center>";
			...
			<a href='home.php?module=setingjawaban&kode=$_POST[kode]'> <b>ULANG LAGI</b></a>";
...
<b class=xbottom></b><b class=xb4></b><b class=xb3></b><b class=xb2></b><b class=xb1></b>
  ...
  <div id=kaki></div>
    ...
    ";
		...
		$input=mysql_query("insert into detpolling values('$_POST[kode]','$_POST[kodejawaban]','$_POST[jawaban]',0)",$konek);

		

		header("location:home.php?module=setingjawaban&kode=$_POST[kode]");
