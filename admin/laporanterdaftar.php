...
<td ><B><font size='3'>LAPORAN CALON MAHASISWA TERDAFTAR </font></B></td>
</tr>
<tr>
<td >
...
<tr><td colspan=11><hr style='border:medium #000000' width=800px></td></tr>";
$mintajadwalperhari=mysql_query("select nopeserta,tgldaftar,nama,jekel,pendidikanakhir from penerimaan where periode='$_POST[periode]'",$konek);
$as=0;
