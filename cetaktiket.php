...
$mintaketjadwal=mysql_query("select pemesanan.notran,pemesanan.tanggal,pemesanan.nojadwal,jadwal.tanggal,jadwal.jam,trayek.keterangan,armada.namaarmada,akun.nama,harga from pemesanan left join jadwal on pemesanan.nojadwal=jadwal.nojadwal left join trayek on jadwal.kodetrayek=trayek.kode left join armada on jadwal.noarmada=armada.noarmada left join akun on pemesanan.noakun=akun.noakun where pemesanan.notran='$_GET[notran]'",$konek);
...
<tr><td>Armada</td><td>:  $pas[6]</td></tr>
...
<td style='background-image:url(admin/images/strip.jpg);width:400px;'>
...
<tr align='center'>
<td style='height:35px;'><b>PASSENGER</b></td></tr>
...
"; 
echo"<br>
*<i>Tiket ini merupakan bukti untuk pemesanan yang sah dan diperlihatkan kepada petugas administrasi PO.CV. Jambi Transport</i>
</div>
